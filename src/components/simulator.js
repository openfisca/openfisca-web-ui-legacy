...
export default class Simulator extends Component {
  ...
  handleMoveIndividu(id) {
    ...
    this.setState({
      editedEntity: this.state.editedEntity && R.equals(this.state.editedEntity, newEditedEntity) ?
  ...
  renderSituateurVisualization(variableName) {
    ...
    if (this.state.simulationResult && this.state.simulationResult[valueKey]) {
      ...
      // Hard-code some values becastrict; of the choice of situateurs variable names.
