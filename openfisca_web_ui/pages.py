...
pages_data = [
    ...
    {
        'scenarios_to_page_korma_data': conv.legislations.scenarios_to_page_korma_data,
        'entity': 'legislations',
        'form_factory': questions.legislations.make_legislations_repeat,
        'korma_data_to_page_api_data': conv.legislations.korma_data_to_page_api_data,
        'name': 'advanced',
        'slug': 'advanced',
        'title': u'Avancé',
        },
