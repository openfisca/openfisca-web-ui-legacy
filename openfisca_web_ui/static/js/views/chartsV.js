...
//  chartsT = require('hbs!chartsT'),
  DistributionChartV = require('./DistributionChartV'),
  IframeChartV = require('./IframeChartV'),
//  legislationsServiceM = require('../models/legislationsServiceM'),
  LocatingChartV = require('./LocatingChartV'),
...
//  testCasesServiceM = require('../models/testCasesServiceM'),
  ...
  WaterfallChartV = require('./WaterfallChartV');
