...
var Backbone = require('backbone'),
  d3 = require('d3'),
// nvd3 seems to be packaged for npm partially so we have to specify the full path.
  nv = require('nvd3/nv.d3'),
  _ = require('underscore');

var LocatingChartM = require('../models/LocatingChartM');
